...
<div class="dgwt-wcas-analytics-date-filter"
	...
	<form class="dgwt-wcas-analytics-date-filter__form js-dgwt-wcas-analytics-date-form" action="#" method="get">
		<div class="dgwt-wcas-analytics-date-filter__controls">
			<div class="dgwt-wcas-analytics-date-filter__field">
				...
				<input type="date"
					   ...
					   name="dgwt_wcas_analytics_date_from"
			...
			<div class="dgwt-wcas-analytics-date-filter__field">
				...
				<input type="date"
					   ...
					   name="dgwt_wcas_analytics_date_to"
			...
			<button type="submit" class="button button-primary js-dgwt-wcas-analytics-apply-date">
